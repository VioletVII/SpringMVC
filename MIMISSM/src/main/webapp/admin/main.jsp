				...
				<div id="bleft">
					...
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/order/splitPage.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/user/splitPage.action" target="myright">
